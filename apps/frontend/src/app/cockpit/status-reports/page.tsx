    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-0.5">Status atual de cada projeto — exibidos no Cockpit</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-gray-400 text-sm">Nenhum status report cadastrado.</p>
      ...
      {historico.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            ...
            <p className="text-xs text-gray-400 mt-0.5">Reports anteriores (substituídos por versões mais recentes)</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
