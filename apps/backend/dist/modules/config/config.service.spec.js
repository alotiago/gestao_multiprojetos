...
const mockCalendario = {
    ...
    tipoFeriado: calendario_dto_1.FeriadoType.NACIONAL,
...
describe('ConfigService', () => {
    ...
    describe('createCalendario', () => {
        it('deve criar um feriado nacional', async () => {
            ...
            expect(mockPrisma.calendario.create).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('findCalendarios', () => {
        it('deve listar feriados com filtros', async () => {
            ...
            const result = await service.findCalendarios({ ano: 2026, tipoFeriado: calendario_dto_1.FeriadoType.NACIONAL });
    ...
    describe('findCalendarioById', () => {
        it('deve lançar NotFoundException para id inexistente', async () => {
            ...
            await expect(service.findCalendarioById('invalid')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('createSindicato', () => {
        ...
        it('deve lançar ConflictException para nome duplicado', async () => {
            ...
            await expect(service.createSindicato({ nome: 'SINTICOT', regiao: 'SP', percentualDissidio: 5.0, regimeTributario: 'CPRB' })).rejects.toThrow(common_1.ConflictException);
        });
    });
    ...
    describe('simularCustoTrabalhista', () => {
        ...
        it('deve lançar NotFoundException para sindicato inexistente', async () => {
            ...
            await expect(service.simularCustoTrabalhista({ sindicatoId: 'invalid', salarioBase: 5000, mes: 1, ano: 2026 })).rejects.toThrow(common_1.NotFoundException);
        });
    });
    // =============================================================
    // ÍNDICES FINANCEIROS
    ...
    describe('createIndice', () => {
        it('deve criar ou atualizar um índice financeiro', async () => {
            ...
            expect(mockPrisma.indiceFinanceiro.upsert).toHaveBeenCalledWith(expect.objectContaining({
