...
describe('SindicatoService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(sindicato_service_1.SindicatoService);
        jest.clearAllMocks();
    });
    describe('create', () => {
    ...
    describe('delete', () => {
        it('deve impedir exclusão com colaboradores ativos', async () => {
            ...
            await expect(service.delete('sind-001')).rejects.toThrow(common_1.ConflictException);
        });
...
//# sourceMappingURL=sindicato.service.spec.js.map